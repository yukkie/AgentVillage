...
| `--players <人数>` | エージェント数（`5` / `7` / `9`）デフォルト: `5`。編成は `frontend/src/config/roles.json` で管理 |
...
| `--players <n>` | Number of agents (`5` / `7` / `9`). Default: `5`. Role sets defined in `frontend/src/config/roles.json` |
